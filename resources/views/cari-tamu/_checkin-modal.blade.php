    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md">
        ...
        <div class="p-6">
            <form id="checkInForm" method="POST" action="">
                @csrf
                {{-- PERBAIKAN: Menambahkan input tersembunyi untuk query pencarian --}}
                <input type="hidden" name="search" id="searchQueryInput">

                <p id="guestName" class="text-xl font-bold text-slate-800 mb-4"></p>
