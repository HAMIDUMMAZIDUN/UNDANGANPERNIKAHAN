<aside 
    class="bg-white p-6 flex flex-col justify-between fixed inset-y-0 left-0 transform lg:relative lg:translate-x-0 transition-all duration-300 ease-in-out z-30"
    ...
    <div>
         <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="flex items-center gap-3 text-sm font-medium text-gray-500 hover:bg-gray-100 p-3 rounded-lg transition-colors"
            :class="isSidebarOpen ? '' : 'lg:justify-center'">
