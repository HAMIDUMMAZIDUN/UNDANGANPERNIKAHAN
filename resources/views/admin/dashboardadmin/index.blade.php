    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Card Server Uptime -->
                <div class="bg-teal-50 p-6 rounded-2xl flex justify-between items-center">
                    <div>
                        <p class="text-4xl font-bold text-teal-600">{{ $serverUptime }}</p>
                        <p class="text-sm text-teal-800 font-medium mt-1">SERVER UP TIME</p>
                    </div>
                    <i class="fas fa-chart-bar text-4xl text-teal-300"></i>
                </div>
                <!-- Card Total Users -->
