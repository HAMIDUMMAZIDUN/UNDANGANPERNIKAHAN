...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@600;700&family=Dancing+Script:wght@700&family=Montserrat:wght@300;400&display=swap" rel="stylesheet">
    ...
    <style>
        body { opacity: 0; transition: opacity 1.5s ease-in-out; background-color: #F8F6F1; }
        #main-content { display: none; }
        .bg-texture { background-image: url('https://www.transparenttextures.com/patterns/foggy-birds.png'); }
    </style>
</head>
<body class="text-brand-dark antialiased overflow-x-hidden font-sans bg-texture">
    ...
    <div class="fixed top-0 right-0 -translate-x-[-25%] -translate-y-[25%] z-10 pointer-events-none opacity-30">
        <img src="https://i.ibb.co/2vTytg2/green-leaf-2.png" alt="Daun" class="w-72 h-auto transform rotate-[120deg]">
    </div>
    <div class="fixed bottom-0 left-0 translate-x-[25%] translate-y-[25%] z-10 pointer-events-none opacity-30">
        <img src="https://i.ibb.co/2vTytg2/green-leaf-2.png" alt="Daun" class="w-72 h-auto transform -rotate-45">
    </div>
    ...
    <div id="cover" class="h-screen w-full flex flex-col justify-center items-center text-center p-4 bg-cover bg-center" style="background-image: url('{{ $event->photo_url }}');">
        ...
        <div class="relative z-20 text-white" data-aos="fade-up">
            <p class="font-serif tracking-widest">A CELEBRATION OF LOVE</p>
