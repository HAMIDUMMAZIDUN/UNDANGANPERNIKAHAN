<div id="profilePopup" class="fixed inset-0 bg-slate-900/70 flex items-center justify-center z-50 hidden">
  
  <div class="bg-slate-800 border border-slate-700 rounded-xl shadow-lg w-full max-w-md p-6 relative">
    <button onclick="toggleProfile()" class="absolute top-3 right-4 text-slate-400 hover:text-white text-2xl">×</button>
