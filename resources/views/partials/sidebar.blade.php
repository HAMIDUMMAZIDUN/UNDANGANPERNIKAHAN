<!-- 
  - `transform -translate-x-full`: Sembunyi di luar layar secara default (untuk mobile).
  - `md:translate-x-0`: Selalu tampil di posisi normal pada layar desktop.
  - `:class`: Atribut Alpine.js untuk memunculkan/menyembunyikan di mobile.
-->
<aside 
    id="sidebar" 
