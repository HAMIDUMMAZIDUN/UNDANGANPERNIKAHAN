...
<div class="bg-slate-50 min-h-screen p-4 sm:p-6 lg:p-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            {{-- DIUBAH: Menggunakan nama route yang benar 'user.setting.index' --}}
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-8">
            {{-- DIUBAH: Menggunakan nama route yang benar 'user.setting.events.gallery.upload' --}}
            <form action="{{ route('user.setting.events.gallery.upload', $event) }}" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            @forelse ($photos as $photo)
                <div class="relative group rounded-lg overflow-hidden shadow-md">
                    ...
                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-all duration-300 flex items-center justify-center">
                        {{-- DIUBAH: Menggunakan nama route yang benar 'user.setting.gallery.delete' --}}
                        <form action="{{ route('user.setting.gallery.delete', $photo) }}" method="POST" class="delete-form">
                            @csrf
                            @method('DELETE')
...
@push('scripts')
{{-- BARU: Menambahkan library SweetAlert2 --}}
