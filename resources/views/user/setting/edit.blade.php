        ...
        <div class="bg-white shadow-md rounded-lg p-6 md:p-8">
            <form action="{{ route('user.setting.events.update', $event) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    {{-- ====================================================================== --}}
                    {{--               DIKEMBALIKAN: Formulir Mempelai Pria                    --}}
                    {{-- ====================================================================== --}}
                    <div class="space-y-6 border-t border-slate-200 pt-6">
                        <h2 class="text-xl font-bold text-slate-800">Detail Mempelai Pria</h2>
                        {{-- Nama Mempelai Pria --}}
                        <div>
                            <label for="groom_name" class="block text-sm font-medium text-slate-700">Nama Mempelai Pria</label>
                            <input type="text" name="groom_name" id="groom_name" value="{{ old('groom_name', $event->groom_name) }}" class="mt-1 shadow-sm block w-full sm:text-sm border-slate-300 rounded-md">
                        </div>
                        {{-- Nama Orang Tua Pria --}}
                        <div>
                            <label for="groom_parents" class="block text-sm font-medium text-slate-700">Nama Orang Tua Pria</label>
                            <input type="text" name="groom_parents" id="groom_parents" value="{{ old('groom_parents', $event->groom_parents) }}" class="mt-1 shadow-sm block w-full sm:text-sm border-slate-300 rounded-md">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="groom_instagram" id="groom_instagram" value="{{ old('groom_instagram', $event->groom_instagram) }}" placeholder="@username" class="mt-1 shadow-sm block w-full sm:text-sm border-slate-300 rounded-md">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2 flex items-center gap-4">
                                ...
                                <input type="file" name="groom_photo" id="groom_photo" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 cursor-pointer"/>
                            </div>
                        </div>
                    </div>

                    {{-- ====================================================================== --}}
                    {{--               DIKEMBALIKAN: Formulir Mempelai Wanita                  --}}
                    {{-- ====================================================================== --}}
                    <div class="space-y-6 border-t border-slate-200 pt-6">
                        <h2 class="text-xl font-bold text-slate-800">Detail Mempelai Wanita</h2>
                        {{-- Nama Mempelai Wanita --}}
                        <div>
                            <label for="bride_name" class="block text-sm font-medium text-slate-700">Nama Mempelai Wanita</label>
                            <input type="text" name="bride_name" id="bride_name" value="{{ old('bride_name', $event->bride_name) }}" class="mt-1 shadow-sm block w-full sm:text-sm border-slate-300 rounded-md">
                        </div>
                        {{-- Nama Orang Tua Wanita --}}
                        <div>
                            <label for="bride_parents" class="block text-sm font-medium text-slate-700">Nama Orang Tua Wanita</label>
                            <input type="text" name="bride_parents" id="bride_parents" value="{{ old('bride_parents', $event->bride_parents) }}" class="mt-1 shadow-sm block w-full sm:text-sm border-slate-300 rounded-md">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="bride_instagram" id="bride_instagram" value="{{ old('bride_instagram', $event->bride_instagram) }}" placeholder="@username" class="mt-1 shadow-sm block w-full sm:text-sm border-slate-300 rounded-md">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2 flex items-center gap-4">
                                ...
                                <input type="file" name="bride_photo" id="bride_photo" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-pink-50 file:text-pink-700 hover:file:bg-pink-100 cursor-pointer"/>
                            </div>
                        </div>
                    </div>
