...
@section('content')
    <div>
        {{-- BAGIAN 1: HEADER DENGAN GAMBAR DAN INFO ACARA --}}
        <div class="relative">
            {{-- Gambar Header --}}
            ...
            {{-- Kotak Info Acara (Diposisikan di atas gambar) --}}
            {{-- PERBAIKAN: Diposisikan 50% dari atas, lalu ditarik ke atas 50% dari tingginya sendiri untuk center vertikal --}}
            <div class="absolute top-2/2 left-0 right-0 -translate-y-1/3 w-11/12 max-w-lg mx-auto">
        ...
        {{-- BAGIAN 2: KONTEN UTAMA (DAFTAR TAMU, DLL) --}}
        <div class="bg-white rounded-lg shadow-md mt-16">
            <div class="p-6"> 
                ...
                <div class="p-3 bg-stone-50 border border-stone-200 rounded-lg mb-6">
                    <p class="text-sm text-stone-600 text-center">
                        ...
                        Tamu Hadir: <span class="font-bold text-stone-900">{{ $jumlahHadir }}</span>
                        <span class="mx-2">|</span>
                        Jumlah Hadir: <span class="font-bold text-stone-900">{{ $totalOrangHadir }}</span>
